...
var _ = Describe("UnixTimeRanges", func() {
	...
	Context("Min", func() {
		...
		It("returns nil when no overlap exists", func() {
			...
			ranges := libtime.UnixTimeRanges{range1, range2}
			result := ranges.Min()
